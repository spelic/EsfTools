...
namespace EsfParser
{
    ...
    public class EsfProgramFunction
    {
        public string ProgramName { get; set; }
        public string FunctionName { get; set; }
        public List<string> Lines { get; set; } = new List<string>();

        public EsfProgramFunction(string programName, string functionName, List<string> lines)
        {
    ...
    public static class EsfProgramFunctions
    {
        public static List<EsfProgramFunction> Functions { get; set; } = new List<EsfProgramFunction>();

        public static void SaveFuntionsToJson(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                throw new ArgumentException("File path cannot be null or empty.", nameof(filePath));
            var json = System.Text.Json.JsonSerializer.Serialize(Functions);
            System.IO.File.WriteAllText(filePath, json);
        }

        public static void LoadFunctionsFromJson(string filePath)
        {
            if (string.IsNullOrEmpty(filePath))
                throw new ArgumentException("File path cannot be null or empty.", nameof(filePath));
            ...
            Functions = System.Text.Json.JsonSerializer.Deserialize<List<EsfProgramFunction>>(json) ?? new List<EsfProgramFunction>();
        }
